...
describe('ng-add-angular-6', () => {
    ...
    beforeEach(() => {
        ...
        testing_2.createCommonWebpackConfigForAngular6(appTree);
    ...
    it('should add 2 new pug rules', () => {
        const oldConfig = eval(test_1.getFileContent(appTree, TARGET_COMMON_CONFIG_PATH));
        const tree = runner.runSchematic('ng-add', defaultOptions, appTree);
        const config = eval(test_1.getFileContent(tree, TARGET_COMMON_CONFIG_PATH));
    ...
    it('should not modify the typescript.js file in webpack config', () => {
        const tree = runner.runSchematic('ng-add', defaultOptions, appTree);
        const newTypescriptConfig = test_1.getFileContent(tree, TARGET_TYPESCRIPT_CONFIG_PATH);
...
describe('ng-add-angular-7-or-greater-specific', () => {
    ...
    beforeEach(() => {
        appTree = testing_2.createTestApp();
        testing_2.createCommonWebpackConfigForAngular7orGreater(appTree);
        runner = new testing_1.SchematicTestRunner('schematics', path.join(__dirname, '../collection.json'));
    });
