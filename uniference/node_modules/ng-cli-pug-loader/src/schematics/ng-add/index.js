...
function addPugRules() {
    return (tree) => {
        ...
        if (commonConfigText.indexOf(strPugRules) > -1) {
            return;
        }
        ...
        if (typescriptConfigText.indexOf('directTemplateLoading') === -1 || typescriptConfigText.indexOf('directTemplateLoading: false,') > -1) {
            return;
        }
